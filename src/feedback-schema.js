...
export const CATEGORIES = Object.freeze({
    grammar: { label: 'Grammar', icon: 'fa-diagram-project', description: 'Sentence structure or grammatical construction.' },
    particle: { label: 'Particle', icon: 'fa-link', description: 'Wrong, missing, excessive, or unnatural particle.' },
    conjugation: { label: 'Conjugation', icon: 'fa-code-branch', description: 'Verb/adjective form, tense, polarity, voice, or aspect.' },
    word_choice: { label: 'Word Choice', icon: 'fa-book', description: 'Vocabulary choice, collocation, or translated wording.' },
    naturalness: { label: 'Naturalness', icon: 'fa-feather', description: 'Understandable but not how Japanese is normally expressed.' },
    meaning: { label: 'Meaning', icon: 'fa-comment-dots', description: 'Ambiguous, inaccurate, or unintended meaning.' },
    register: { label: 'Register', icon: 'fa-user-tie', description: 'Politeness, tone, relationship, or character voice.' },
    context: { label: 'Context', icon: 'fa-comments', description: 'Does not fit or properly answer the conversation.' },
    orthography: { label: 'Orthography', icon: 'fa-pen-nib', description: 'Kanji/kana choice, spelling, or script choice.' },
    punctuation: { label: 'Punctuation', icon: 'fa-ellipsis', description: 'Japanese punctuation, spacing, or formatting.' },
    other: { label: 'Other', icon: 'fa-circle-info', description: 'Uncategorized observation.' },
});

...
function buildContractSection() {
    ...
    return [
        ...
        '  "summary": "concise overall assessment in ENGLISH (1-3 sentences)",',
        '  "revisedText": "full corrected JAPANESE version of the target, or null when no rewrite is needed",',
        '  "strengths": [',
        '    { "quote": "exact Japanese text from the target", "explanation": "why this specific choice works, in ENGLISH" }',
        '  ],',
        '  "issues": [',
        '    {',
        ...
        '      "quote": "exact Japanese substring copied verbatim from the target",',
        '      "occurrence": 1,',
        '      "sentence": "the Japanese sentence in the target that contains the quote (optional)",',
        '      "explanation": "what is wrong or what to understand, in ENGLISH (use Japanese only when explanatory needed)",',
        '      "replacement": "suggested Japanese replacement (use \\"\\" when only explaining)",',
        '      "alternatives": ["optional alternative Japanese replacements"]',
        '    }',
        '  ]',
        '}',
        '',
        'Rules for the JSON:',
        '- Explanatory fields ("summary", "explanation") are ENGLISH. Language-content fields ("quote", "replacement", "alternatives", "revisedText", "sentence") are the learner\'s Japanese.',
